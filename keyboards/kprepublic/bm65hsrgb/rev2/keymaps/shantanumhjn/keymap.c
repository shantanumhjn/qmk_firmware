...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
 ...
 LT(2, KC_CAPS),      HOME_A,   HOME_R,   HOME_S,   HOME_T,   KC_D,   KC_H,HOME_N,  HOME_E, HOME_I,   HOME_O,   KC_QUOT,             KC_ENT,   KC_PGUP,
        KC_LSFT,          KC_Z,     KC_X,    KC_C,      KC_V,   KC_B,   KC_K, KC_M, KC_COMM,  KC_DOT,   KC_SLSH,           KC_RSFT,  KC_UP,    KC_PGDN,
        KC_LCTL,  KC_LGUI,  KC_LALT,                            KC_SPC,                     KC_GRAVE,   MO(2),             KC_LEFT,  KC_DOWN,  KC_RGHT
    ),
 ...
 LT(2, KC_CAPS),        KC_A,   KC_S,   KC_D,   KC_F,   KC_G,   KC_H,   KC_J,   KC_K,   KC_L,   KC_SCLN,  KC_QUOT,              KC_ENT,   KC_PGUP,
    ...
    [2] = LAYOUT_65_ansi_blocker(
       KC_GRAVE,  KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_F7,   KC_F8,   KC_F9,  KC_F10,  KC_F11,  KC_F12,     _______,  _______,
        ...
        _______,      DF(0),    DF(1), _______, _______, _______, _______,  KC_LEFT,  KC_DOWN, KC_UP, KC_RIGHT, _______,        _______,  _______,
        _______,       DT_UP,  DT_DOWN, DT_PRNT, _______,   RESET, _______, _______, _______, _______, _______,     _______,    _______,  _______,
